...
const ContactForm = () => {
  ...
  <div className="bg-white shadow-lg p-10 rounded-lg max-w-6xl w-full flex flex-col lg:flex-row relative">
    ...
    /*<div className="flex justify-center items-center min-h-screen bg-gray-100 p-6">
      <div className="bg-white shadow-lg p-10 rounded-lg max-w-4xl w-full flex">
        ...
        <div className="w-1/2 pr-8 border-r border-gray-300">
          ...
          <div className="mb-4">
            <p className="text-gray-500 uppercase text-xs">Linkedin</p>
            <p className="text-gray-800"><a href="https://www.linkedin.com/in/maria-voicu-951b68300/" className="text-gray-800 uppercase text-xs">Voicu Maria</a></p>
          </div>
          <div className="mb-4">
            <p className="text-gray-500 uppercase text-xs">Address</p>
            <p className="text-gray-800">București,România</p>
        ...
        <form onSubmit={handleSubmit} className="w-1/2 pl-8">
          <input
            type="text"
            name="name"
            placeholder="NAME"
